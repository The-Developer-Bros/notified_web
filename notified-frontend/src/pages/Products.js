...
const style1 = { width: "152px" };
const style2 = { left: "30%", width: "50%" };
const style3 = { left: "30%" };
const style4 = { left: "80%" };
const style5 = { top: "-30px", left: "50.1px" };

const styleTemp = { position: "relative" , align: "center" , marginTop: "100px"}
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-3">
                                        ...
                                        <div className="slider-primary">
                                            <div className="slider slider-horizontal" styles={style1}>
                                                <div className="slider-track">
                                                    <div className="slider-selection" styles={style2}>
                                                    </div>
                                                    <div className="slider-handle round" styles={style3}>
                                                    </div>
                                                    <div className="slider-handle round" styles={style4}>
                                                    </div>
                                                </div>
                                                <div className="tooltip top hide" styles={style5}>
